...
public class Order implements Comparable<Order> {
    ...
    /**
     * Creates a new order with the specified unique identifier, price, quantity, and order side.
     * This is a private constructor used internally for creating copies of existing orders.
     *
     ...
     * @param side     the order side (buy or sell) of the order.
     */
    private Order(UUID id, BigDecimal price, int quantity, OrderSide side) {
    ...
    /**
     * Returns a new instance of Order with the same attributes as this object but with a new quantity.
     *
     * @param newQuantity the new quantity of the Order
     * @return a new instance of Order with the same attributes as this object but with a new quantity.
     */
    public Order withQuantity(int newQuantity) {
        return new Order(this.getId(), this.getPrice(), newQuantity, this.getSide());
    }
